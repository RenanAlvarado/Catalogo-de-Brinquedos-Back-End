...
INSERT INTO brinquedos (nome, descricao, imagem, preco, categoria_id) VALUES ('Carrinho Hot Wheels', 'Carrinho de metal em miniatura da linha Hot Wheels', 'hotwheels.jpg', 19.90, 1);

INSERT INTO brinquedos (nome, descricao, imagem, preco, categoria_id) VALUES ('Boneca Barbie', 'Boneca Barbie classica com acessorios', 'barbie.jpg', 89.90, 2);

INSERT INTO brinquedos (nome, descricao, imagem, preco, categoria_id) VALUES ('Lego City Policia', 'Conjunto Lego City com viatura policial', 'lego-police.jpg', 159.90, 6);

INSERT INTO brinquedos (nome, descricao, imagem, preco, categoria_id) VALUES ('Dinossauro T-Rex', 'Dinossauro de brinquedo articulado', 'trex.jpg', 49.90, 19);

INSERT INTO brinquedos (nome, descricao, imagem, preco, categoria_id) VALUES ('Quebra cabeca 500 pecas', 'Quebra cabeca infantil de 500 pecas', 'puzzle500.jpg', 39.90, 9);

INSERT INTO brinquedos (nome, descricao, imagem, preco, categoria_id) VALUES ('Caminhao de Bombeiro', 'Caminhao de bombeiro com escada movel', 'bombeiro.jpg', 74.90, 1);
